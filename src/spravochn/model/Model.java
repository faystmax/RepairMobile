 ...
 * @author tigler
 */
public class Model extends javax.swing.JFrame implements UpdatesDataInForms {
    ...
    public void addDataInTable() {
        ...
        jTable1.getColumnModel().getColumn(3).setHeaderValue("Производитель");
    }
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            ModelAddUpdate modelAddUpdate = new ModelAddUpdate(1, primKey);
            modelAddUpdate.setListenerCloseForm(new ListenerCloseForm(this));
            this.setEnabled(false);
            modelAddUpdate.setVisible(true);
        }
